...
namespace SharpFEGrasshopper.Tests.TypesTests
{
    ...
    public class Full3DTestClass
    {
        ...
        public void CanAddSupportToModel() {
            ...
            ICollection<IFiniteElementModel> nodes = model.Points.Keys;
            nodes.GetEnumerator();
            
            Assert.IsTrue(model.Model.IsConstrained(, DegreeOfFreedom.X));
        ...
        public void Truss() {
            ...
            Vector3d displacement = model.GetNodeDisplacement(p2); //Displacement at point2 (index 1)
